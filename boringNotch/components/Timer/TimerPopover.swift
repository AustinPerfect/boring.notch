...
struct TimerPopover: View {
    ...
    var body: some View {
        ...
        // 移除这个onChange以避免循环更新：用户编辑→更新customTimerDuration→触发onChange→重置用户编辑
    }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Grid(alignment: .leading, horizontalSpacing: 12, verticalSpacing: 8) {
                GridRow {
                    TimerPopoverDurationStepper(title: "Hours", value: $hours, range: 0...23)
                    TimerPopoverDurationStepper(title: "Minutes", value: $minutes, range: 0...59)
                    TimerPopoverDurationStepper(title: "Seconds", value: $seconds, range: 0...59)
                }
            }
...
private struct TimerPopoverDurationStepper: View {
    let title: String
